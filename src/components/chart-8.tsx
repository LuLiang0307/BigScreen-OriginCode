  ...
  return (
    <div className="年龄段-图2">
      ...
      <div className="legend">
        <span style={{ background: colors[0] }} />10-20岁
        <span style={{ background: colors[1] }} />20-30岁
        <span style={{ background: colors[2] }} />30-40岁
        <span style={{ background: colors[3] }} />40-50岁
        <span style={{ background: colors[4] }} />50-60岁
      </div>
    </div>
  )
}